 ...
 *
 * @param {ActorMKA} actor           Actor that is taking the long rest.
...
export default class LongRestDialog extends Dialog {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/mka/templates/apps/long-rest.hbs",
      classes: ["mka", "dialog"]
    });
  }
   ...
   * @param {ActorMKA} [options.actor]  Actor that is taking the long rest.
   * @returns {Promise}                Promise that resolves when the rest is completed or rejects when canceled.
   */
  static async longRestDialog({ actor } = {}) {
    return new Promise((resolve, reject) => {
      const dlg = new this(actor, {
        title: `${game.i18n.localize("MKA.LongRest")}: ${actor.name}`,
        buttons: {
          rest: {
