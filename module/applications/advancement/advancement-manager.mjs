...
export default class AdvancementManager extends Application {
   ...
   * @param {ActorMKA} actor               Actor from which the advancement should be updated.
   ...
   * @param {ActorMKA} actor         Actor from which the advancement should be unapplied.
   ...
   * @param {ItemMKA} item    Item being advanced. If class or subclass, its level will be used.
   * @param {ActorMKA} actor  Actor being advanced.
