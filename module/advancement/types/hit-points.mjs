...
export class HitPointsAdvancement extends Advancement {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      order: 10,
      icon: "systems/mka/icons/svg/hit-points.svg",
      title: game.i18n.localize("MKA.AdvancementHitPointsTitle"),
      hint: game.i18n.localize("MKA.AdvancementHitPointsHint"),
      multiLevel: true,
  ...
  /** @inheritdoc */
  get levels() {
    return Array.fromRange(CONFIG.MKA.maxLevel + 1).slice(1);
  }
...
export class HitPointsConfig extends AdvancementConfig {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/mka/templates/advancement/hit-points-config.hbs"
    });
  }
...
export class HitPointsFlow extends AdvancementFlow {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      template: "systems/mka/templates/advancement/hit-points-flow.hbs"
    });
  }
  ...
  _updateObject(event, formData) {
    ...
    throw new Advancement.ERROR(game.i18n.localize(`MKA.AdvancementHitPoints${errorType}Error`));
  }
