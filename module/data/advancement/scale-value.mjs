  ...
  static defineSchema() {
    return {
      ...
      type: new foundry.data.fields.StringField({
        required: true, initial: "string", choices: TYPES, label: "MKA.AdvancementScaleValueTypeLabel"
      }),
      distance: new foundry.data.fields.SchemaField({
        units: new foundry.data.fields.StringField({required: true, label: "MKA.MovementUnits"})
      }),
...
export class ScaleValueType extends foundry.abstract.DataModel {
  ...
  static get metadata() {
    return {
      label: "MKA.AdvancementScaleValueTypeString",
      hint: "MKA.AdvancementScaleValueTypeHintString",
      isNumeric: false
    };
  }
...
export class ScaleValueTypeNumber extends ScaleValueType {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "MKA.AdvancementScaleValueTypeNumber",
      hint: "MKA.AdvancementScaleValueTypeHintNumber",
      isNumeric: true
    });
  }
...
export class ScaleValueTypeCR extends ScaleValueTypeNumber {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "MKA.AdvancementScaleValueTypeCR",
      hint: "MKA.AdvancementScaleValueTypeHintCR"
    });
  }
...
export class ScaleValueTypeDice extends ScaleValueType {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "MKA.AdvancementScaleValueTypeDice",
      hint: "MKA.AdvancementScaleValueTypeHintDice"
    });
  }
...
export class ScaleValueTypeDistance extends ScaleValueTypeNumber {
  ...
  static get metadata() {
    return foundry.utils.mergeObject(super.metadata, {
      label: "MKA.AdvancementScaleValueTypeDistance",
      hint: "MKA.AdvancementScaleValueTypeHintDistance"
    });
  }
  ...
  /** @inheritdoc */
  get display() {
    return `${this.value} ${CONFIG.MKA.movementUnits[this.parent.configuration.distance?.units ?? "ft"]}`;
  }
}
