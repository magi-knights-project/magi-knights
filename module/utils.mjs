 ...
 * (e.g. "mka.actor-traits").
 * @returns {Promise}
 */
export async function preloadHandlebarsTemplates() {
  const partials = [
    // Shared Partials
    "systems/mka/templates/actors/parts/active-effects.hbs",
    "systems/mka/templates/apps/parts/trait-list.hbs",

    // Actor Sheet Partials
    "systems/mka/templates/actors/parts/actor-traits.hbs",
    "systems/mka/templates/actors/parts/actor-inventory.hbs",
    "systems/mka/templates/actors/parts/actor-features.hbs",
    "systems/mka/templates/actors/parts/actor-spellbook.hbs",
    "systems/mka/templates/actors/parts/actor-warnings.hbs",

    // Item Sheet Partials
    "systems/mka/templates/items/parts/item-action.hbs",
    "systems/mka/templates/items/parts/item-activation.hbs",
    "systems/mka/templates/items/parts/item-advancement.hbs",
    "systems/mka/templates/items/parts/item-description.hbs",
    "systems/mka/templates/items/parts/item-mountable.hbs",
    "systems/mka/templates/items/parts/item-spellcasting.hbs",
    "systems/mka/templates/items/parts/item-summary.hbs",

    // Journal Partials
    "systems/mka/templates/journal/parts/journal-table.hbs",

    // Advancement Partials
    "systems/mka/templates/advancement/parts/advancement-ability-score-control.hbs",
    "systems/mka/templates/advancement/parts/advancement-controls.hbs",
    "systems/mka/templates/advancement/parts/advancement-spell-config.hbs"
  ];

  const paths = {};
  for ( const path of partials ) {
    paths[path.replace(".hbs", ".html")] = path;
    paths[`mka.${path.split("/").pop().replace(".hbs", "")}`] = path;
  }
...
function itemContext(context, options) {
  if ( arguments.length !== 2 ) throw new Error("#mka-itemContext requires exactly one argument");
...
export function registerHandlebarsHelpers() {
  Handlebars.registerHelper({
    ...
    "mka-linkForUuid": linkForUuid,
    "mka-itemContext": itemContext
  });
}
 ...
 * @param {string} configKeyPath          Key path within `CONFIG.MKA` to localize.
 ...
 * @param {object} config  The `CONFIG.MKA` object to localize and sort. *Will be mutated.*
 */
 ...
 * @param {ActorMKA} actor
 * @param {Object<string,ItemMKA>} spellsMap
